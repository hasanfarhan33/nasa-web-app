...
const ApodComponent = () => {
    ...
    if (!apod) return <p className='text-center text-gray-700'>Loading...</p>;
        ...
        return (
            <section className="bg-gradient-to-b from-gray-50 to-gray-300 shadow-lg border border-gray-200 rounded-xl p-8 mx-auto max-w-3xl mt-10">
                ...
                <figure className="flex flex-col items-center">
                    <img src={apod.url} alt={apod.title} className="w-full max-w-2xl rounded-lg shadow-sm"/>
            ...
            <section className="bg-gradient-to-b from-gray-50 to-gray-300 shadow-lg border border-gray-200 rounded-xl p-8 mx-auto max-w-3xl mt-10">
                ...
                <figure className="flex flex-col items-center">
                    <iframe 
                        ...
                        width="100%" 
                        height="500px"
                        className="w-full h-96 max-w-2xl rounded-lg shadow-md"
                    ></iframe>
                    <figcaption className="mt-5 text-lg font-semibold text-gray-800 text-center">{apod.title}</figcaption>
                </figure>
            </section>
